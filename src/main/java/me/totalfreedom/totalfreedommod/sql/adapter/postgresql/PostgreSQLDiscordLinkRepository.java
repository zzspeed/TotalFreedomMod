...
public class PostgreSQLDiscordLinkRepository implements DiscordLinkRepository
{
    private final TotalFreedomMod plugin;
    private final StatementHandler statementHandler;

    public PostgreSQLDiscordLinkRepository(TotalFreedomMod plugin, StatementHandler statementHandler)
    {
        this.plugin = plugin;
    ...
    public void insert(UUID adminUuid, String discordUserId) throws SQLException
    {
        statementHandler.executeUpdate(
                "INSERT INTO \"discord_links\" (\"admin_uuid\", \"discord_user_id\", \"linked_at\") VALUES (?, ?, CURRENT_TIMESTAMP)",
